...
var update = __webpack_require__(6)("2b93fa1a", content, false, {});
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(6)("3cb2a8ea", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
                    ...
                    _c("div", { staticClass: "manual-item" }, [
                      _c("div", { staticClass: "page-count" }, [
                        _vm._v(
                          _vm._s(_vm.index + 1) +
                            " / " +
                            _vm._s(_vm.totalSize ? _vm.totalSize : _vm.length)
                        )
                      ]),
                      _vm._v(" "),
                      _c(
